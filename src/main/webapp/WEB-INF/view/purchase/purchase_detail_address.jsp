...
<div class="address_area">
    ...
    <div id="addr_DEFAULT" class="addr_box" style="display: block;">
...
<div class="delivery_memo_area" style="margin-top: 20px;">
    <label><strong>배송 메모</strong></label><br>
    <select name="delivery_memo_select" id="delivery_memo_select" onchange="toggleMemoInput()" style="width: 100%; padding: 5px;">
    ...
    <div id="direct_memo_div" style="display: none; margin-top: 10px;">
